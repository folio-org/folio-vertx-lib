...
public class PgCqlQueryTest {
  ...
  public void testSimple() {
    ...
    pgCqlDefinition.addField("dc.title", new PgCqlFieldText(false).withColumn("title"));
  ...
  public void testQueries() {
    ...
    pgCqlDefinition.addField("isbn", new PgCqlFieldText(false));
